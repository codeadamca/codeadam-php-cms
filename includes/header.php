...
<head>
  ...
  <link href="https://codeadam.ca/styles/styles.css" type="text/css" rel="stylesheet">
...
<body>
  ...
  <?php if( isset( $_SESSION['id'] ) ): ?>  
    ...
    <p style="padding: 0 1%; text-align: center;">
      ...
      <a href="https://codeadam.ca"><i class="fas fa-search"></i> Website</a> | 
