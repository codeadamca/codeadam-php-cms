...
if( isset( $_FILES['photo'] ) )
{
  ...
  if( $_FILES['photo']['error'] == 0 )
  {
    ...
    set_message( 'Topics photo has been updated' );
...
if( isset( $_GET['id'] ) )
{
  ...
  if( isset( $_GET['delete'] ) )
  {
    ...
    set_message( 'Topic photo has been deleted' );
...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="topics_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
...
<p><a href="topics.php"><i class="fas fa-arrow-circle-left"></i> Return to Topic List</a></p>
