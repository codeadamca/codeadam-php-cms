...
if( isset( $_FILES['photo'] ) )
{
  ...
  set_message( 'Page photo has been updated' );
...
if( isset( $_GET['id'] ) )
{
  ...
  if( isset( $_GET['delete'] ) )
  {
    ...
    set_message( 'Page photo has been deleted' );
...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="pages_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
